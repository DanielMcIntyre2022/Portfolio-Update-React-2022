...
import { SiCss3, SiJavascript, SiSass, SiReact, SiFirebase, SiExpress, SiHeroku, SiNetlify, SiMongodb, SiBootstrap, SiMinutemailer, SiMeteor, SiStripe,  SiTailwindcss, SiAngular, SiRailway, SiRedux} from 'react-icons/si'
      ...
      <div ref={skillsRef} className="skills-wrapper ">
          ...
          <div className="skills-title react">
            ...
            <div className="skills-title vue">
                    <FaVuejs/><h4>Vue</h4>
                    <p>Builds innovative Vue web applications with the Vue front-end framework.</p>
            </div>
            ...
            <div className="skills-title Meteor-JS">
                    <SiMeteor/><h4>Meteor JS</h4>
                    <p>Experienced in building large-scale projects ulitizing the full-stack Meteor JS framework.
              </p>
          </div>
          <div className="skills-title Meteor-JS">
                    <SiRedux/><h4>Redux / Redux Toolkit</h4>
                    <p>Experienced in ultizing application statement tool Redux and Redux Toolkit in large-scale applications.
              </p>
          </div>
